...
class UnalignedDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        if btoa:
            ...
            A_paths = make_dataset(self.dir_A,self.opt.max_dataset_size)
            ...
            B_paths = make_dataset(self.dir_B,self.opt.max_dataset_size)
